      ...
      <div class="grid grid-cols-10 gap-0 lg:gap-10">
        <div class="col-span-10 lg:col-span-7">
          ...
          <div class="flex flex-col justify-center">
            ...
            <NewsFromInci :data="newss" :base-url="detailPageSettings.route" />
          </div>
...
<script>
  ...
  export default {
    name: "news",
    layout: "default",
    components: { LittleHero, NewsFromInci, MediaSidebar },
    async asyncData({ i18n, route }) {
      ...
      var detailPageSettings = await pageSettingService.getPageSetting(
        "news-detail",
        i18n.locale
      );
      ...
      detailPageSettings.route = '/' + i18n.locale + detailPageSettings.route;
      ...
      var newss = newsResult.result;

      var pageCount = parseInt(Math.ceil(newsResult.totalCount / pageFilter.limit));


      return { pageSettings, sideMenu, newss, pageCount, currentPage, detailPageSettings };
    },
    methods: {
      getFullPage(i) {
