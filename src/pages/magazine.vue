      ...
      <div class="grid grid-cols-10 gap-0 lg:gap-10">
        <div class="col-span-10 lg:col-span-7">
          ...
          <div class="flex flex-col justify-center">
            ...
            <MagazineFromInci :magazines="magazines" />
          </div>
...
<script>
  ...
  import MagazineFromInci from "../components/MagazineFromInci.vue";
  ...
  export default {
    name: "magazine",
    layout: "default",
    components: { LittleHero, MagazineFromInci, MediaSidebar },
    async asyncData({ i18n, route }) {
      ...
      var magazineResult = await mediaService.getMagazine(pageFilter);
      var magazines = magazineResult.result;

      var pageCount = parseInt(Math.ceil(magazineResult.totalCount / pageFilter.limit));


      return { pageSettings, sideMenu, magazines, pageCount, currentPage };
    },
    methods: {
      getFullPage(i) {
